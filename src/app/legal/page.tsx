    ...
    <div className="min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] p-4 sm:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="bg-[var(--color-card-bg)] rounded-2xl p-6 border border-[var(--color-header-border)] space-y-6">
          ...
          {/* Data Access Warning */}
          <div className="bg-[var(--alert-warn-bg)] border border-[var(--alert-warn-border)] rounded-xl p-4 space-y-2">
            <h3 className="font-bold text-[var(--alert-warn-title)] flex items-center gap-2">
              ⚠️ 運営者によるデータアクセスについて
            </h3>
            <div className="text-sm text-[var(--alert-warn-text)]">
              <p>
